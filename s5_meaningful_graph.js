...
//         data += comma + "[new Date(2019,03-2,"+ r.id +",00,38),"+ r.value +"]";
	 data += comma + "[new Date(" + r.CurrentDate[0] + r.CurrentDate[1] + r.CurrentDate[2] + r.CurrentDate[3]
         ...
         comma = ",";
	 if(i == 0)
	      var start = "" + r.CurrentDate[0] + r.CurrentDate[1] + r.CurrentDate[2] + r.CurrentDate[3]
	      		+ "-" + r.CurrentDate[4] + r.CurrentDate[5] + "-" + r.CurrentDate[6] + r.CurrentDate[7]
	      		+ " " + r.CurrentTime[0] + r.CurrentTime[1] + ":" + r.CurrentTime[2] + r.CurrentTime[3]
	      		+ ":" + r.CurrentTime[4] + r.CurrentTime[5];
	 if(i == rows.length - 1)
	      var end = "" + r.CurrentDate[0] + r.CurrentDate[1] + r.CurrentDate[2] + r.CurrentDate[3]
	      		+"-" + r.CurrentDate[4] + r.CurrentDate[5] + "-" + r.CurrentDate[6] + r.CurrentDate[7]
	      		+ " " + r.CurrentTime[0] + r.CurrentTime[1] + ":" + r.CurrentTime[2] + r.CurrentTime[3]
	      		+ ":" + r.CurrentTime[4] + r.CurrentTime[5];
      }
      ...
      res.write(html);
      res.end('Start Time : ' + start + ' / ' + 'End Time : ' + end);
    });
  });
})
